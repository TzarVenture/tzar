    ...
    [
      {
        ...
        text: "Search Engine Optimisation (SEO) is the process of improving the visibility of website in the organic search engine results, so that it can be found by potential customers more easily. A combination of keyword research, on-page optimisation, link building and content creation is used to ensure that you reach the right audience.",
      },
      {
        id: 2,
        title: " What is Content Marketing",
        text: "Content marketing is an effective digital marketing strategy for creating interesting, and relevant content to attract and retain a specific audience. It can be used to attract potential customers, create loyalty, engage with prospects, build relationships with customers, promote products and services, and educate the public about your company.",
      },
      {
        id: 3,
        title: "What do you mean by social media marketing?",
        text: "Social media marketing (SMM) is a form of marketing that utilizes social networking sites to connect with your target audience. Through SMM, you can build brand awareness, attract potential customers, boost sales, and drive traffic to your website.",
      },
    ],
    [
      {
